...
public class Solution {
    ...
    static { //заполнение массива числами от 0 до 999
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 1000 - 1; i >= 0; i--) { //заполняем ожидаемый результат как 0-999
            expectedResult.append(i).append(" ");
        }

        initThreads(); // инициализация 10 тредов и их работа

        StringBuffer result = new StringBuffer(); //результат параллельной сортировки десятью тредами
    ...
    public static void sort(int[] array) { // сортировка по убыванию
