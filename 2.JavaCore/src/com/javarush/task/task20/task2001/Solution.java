...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("C:\\Users\\Veniol\\Desktop\\dest.txt", null);
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (this.assets!= null){
                ...
                outputStream.write("-".getBytes());//implement this method - реализуйте этот метод
            }
            outputStream.flush();
        }
