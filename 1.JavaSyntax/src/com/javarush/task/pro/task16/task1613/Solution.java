...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        int dayNumber = dateTime.getDayOfWeek().getValue();
        int hours = dateTime.toLocalTime().getHour();
        return (dayNumber == FRIDAY && hours >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR) || dayNumber == SATURDAY || (dayNumber == SUNDAY && hours <WEEKEND_END_SUNDAY_CUT_OFF_HOUR);
    }
}
